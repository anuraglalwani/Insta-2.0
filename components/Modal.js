...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    //3 upload the image to firebase storage with th pos id
              ...
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    type="button"
                    className="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 text-base  font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:cursor-not-allowed disabled:bg-gray-300 hover:disabled:bg-gray-300 sm:text-sm"
                  >
